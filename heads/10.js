...
// if (location.pathname === '/') {
  ...
  // $("body").css({
  //   "background-image": "url('/heads/data/10.jpg')",
  //  });
...
function init() {
  ...
  var mapHeight = new THREE.TextureLoader().load( "/heads/FBHead_baked_tex.png" );
  ...
  loader.load( "/heads/cat_head.glb", function ( gltf ) {
